...
class JacketViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
...
//                self.navigationController?.pushViewController(nxtvc, animated: true)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "JacketCollectionViewCell", for: indexPath)as! JacketCollectionViewCell
...
//        SweaterBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
    ...
    @IBAction func Cncl(_ sender: Any) {
        BlackBtn.isHidden = true
        UIView.animate(withDuration: 0.4, animations:{ self.MenuBtn.frame.origin.x = -self.MenuView.frame.size.width })
    ...
    @IBAction func MenuBtn(_ sender: Any) {
        ...
        UIView.animate(withDuration: 0.4, animations:{ self.MenuBtn.frame.origin.x = 0 })
