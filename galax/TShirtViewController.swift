...
class TShirtViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate  {
    @IBOutlet weak var SweaterBtn: UIButton!
    @IBOutlet weak var ShoeBtn: UIButton!
    @IBOutlet weak var jacketBtn: UIButton!
    @IBOutlet weak var JeansBtn: UIButton!
    @IBOutlet weak var TshirtBtb: UIButton!
    ...
    override func viewDidLoad() {
        ...
        if storyboardId == "TShirtViewController" {
            FrstView.isHidden = false
            TshirtBtb.setTitleColor(UIColor.red, for: UIControlState.normal)
        }
...
//                self.navigationController?.pushViewController(nxtvc, animated: true)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TShirtCollectionViewCell", for: indexPath)as! TShirtCollectionViewCell
...
//        FivView.isHidden = true
//        TshirtBtb.setTitleColor(UIColor.red, for: UIControlState.normal)
//        JeansBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
...
//        SweaterBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
    ...
    @IBAction func JeansBtn(_ sender: Any) {
        ...
        ForthView.isHidden = true
        FivView.isHidden = true
        TshirtBtb.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
        JeansBtn.setTitleColor(UIColor.red, for: UIControlState.normal)
        jacketBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
        ShoeBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
        SweaterBtn.setTitleColor(UIColor(red: 111.0/255.0, green: 111.0/255.0, blue: 111.0/255.0, alpha: 1), for: UIControlState.normal)
    }
